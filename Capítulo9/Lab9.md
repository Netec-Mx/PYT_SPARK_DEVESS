# Laboratorio 9: Monitoreo y optimización de PySpark

**Objetivo:** - Identificar y aplicar mejores prácticas de desempeño y
el uso de Catalyst Optimizer.
...
## Tarea1: Monitoreo del Código en PySpark
...
**Ejemplo**: Después de ejecutar un trabajo en PySpark, abre la Spark UI
para ver:
...
Los logs de Spark proporcionan información detallada sobre el progreso
...
-   Mantener en cache DataFrames si se reutilizan en múltiples
    operaciones.
...
-   Asegúrae de que los datos estén bien particionados para paralelizar
    el procesamiento.
